...
export default function MobileLayout({ children }: { children: ReactNode }) {
  ...
  return (
    // 👇 SỬA 1: Thêm dark:bg-gray-900 và dark:text-gray-100 để đổi màu nền/chữ tổng thể
    <div className="flex flex-col h-screen bg-gray-50 dark:bg-gray-900 text-gray-800 dark:text-gray-100 transition-colors duration-300">
      ...
      {/* 👇 SỬA 2: Thêm dark:bg-gray-800 và dark:border-gray-700 cho thanh Menu */}
        ...
        {menu.map((item) => {
          ...
          return (
            <button
              ...
              // 👇 SỬA 3: Chỉnh màu icon khi Active và Hover trong chế độ tối
